<div class="mt-2">
    ...
    <form method='Post' action="{{ route('register') }}" class="mt-2 flex flex-col gap-2">
        @csrf
        ...
        <button type="submit" class="bg-blue-500 text-white p-2 rounded-md hover:bg-blue-600 transition-colors duration-300 mt-4">Зарегистрироваться</button>
    </form>
</div>